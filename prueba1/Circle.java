...
public class Circle {
	...
	private float[] createCircleCoords(float radius, int numPoints, float[] center) {
		List<Float> coords = new ArrayList<>();

		coords.add(center[0]); // center x
		coords.add(center[1]); // center y
	...
	public Circle(float radius, int numPoints, float[] center) {
		circleCoords = createCircleCoords(radius, numPoints, center);
